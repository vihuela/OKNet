...
import ricky.oknets.model.LzyResponse;
import ricky.oknets.model.SimpleResponse;
...
public class JsonConvert<T> implements Converter<T> {
    ...
    public T convertSuccess(Response response) throws Exception {
        ...
        if (typeArgument == Void.class) {
            ...
            SimpleResponse simpleResponse = DataConvert.fromJson(jsonReader, SimpleResponse.class);
            response.close();
            //noinspection unchecked
            return (T) simpleResponse.toLzyResponse();
        } else if (rawType == LzyResponse.class) {
            //有数据类型，表示有data
            LzyResponse lzyResponse = DataConvert.fromJson(jsonReader, type);
            response.close();
