package ricky.oknets.callback.show;
 ...
 * @param <T>
 */
public abstract class JsonCallback_Unknow<T> extends AbsCallback<T> {
        ...
        if (type == String.class) {
            ...
            if (CommonResponse.class.isInstance(t)) {
                ...
                switch (t1.code) {
                    ...
                    default:
                        throw new IllegalArgumentException("I am big trouble");
                }
